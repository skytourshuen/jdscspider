...
class GetUser(threading.Thread):
    ...
    db = None
    db_cursor = None
    max_queue_len = 1000  # redis带抓取用户队列最大长�?
    ua = (
    ...
    def __init__(self, threadID=1, name=''):
        # 多线�?
        print("线程" + str(threadID) + "初始�?")
        threading.Thread.__init__(self)
        self.threadID = threadID
        self.name = name
        try:
            print("线程" + str(threadID) + "初始化成�?")
        except Exception as err:
            print(err)
            print("线程" + str(threadID) + "�?启失�?")
    ...
    def get_all_follower(self, name_url):
        ...
        # 获取关注者列�?
        per_page = 20
        # �?始获取所有的关注�? math.ceil(follower_num/20)*20
    ...
    def get_user_info(self, name_url):
        ...
        try:
            ...
            self_domain = user_type + '/' + user_info['url_token']  # 个�?�域�?
